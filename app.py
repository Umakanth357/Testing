...
CHARACTER_CHOICES = [("Navya (Telugu F, Hyderabad)", "navya"),
...
def analyse_content(source: str, language: str, format_type: str,
                    ...
                    debate_pos_navya: str = "in favour",
    ...
    if format_type == "debate" or (format_type == "auto"):
        debate_positions = {"navya": debate_pos_navya, "arjun": debate_pos_arjun}
            ...
            with gr.TabItem("1 · Content"):
                ...
                with gr.Row():
                    ...
                    with gr.Column(scale=1):
                        ...
                        character_input = gr.Dropdown(CHARACTER_CHOICES, value="navya",
                                                       label="Primary Character (Navya / Arjun)")
                        duration_input  = gr.Slider(30, 600, value=180, step=30,
                                                    label="Target Duration (seconds)")

                with gr.Accordion("Debate Settings (if format = Debate)", open=False):
                    with gr.Row():
                        debate_navya_pos = gr.Textbox(
                            label="Navya's Position", value="in favour",
